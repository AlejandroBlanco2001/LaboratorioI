...
/*
    ...
    This class was taken of Rob Camick web page https://tips4java.wordpress.com/2009/11/29/text-prompt/

    The only use of this class is for visual purposes, to make the placeholders for the text fields
